...
import { Command, CommandContribution, CommandRegistry, MAIN_MENU_BAR, MenuContribution, MenuModelRegistry, MenuNode, MessageService, QuickInputService, SubMenuOptions,  } from '@theia/core/lib/common';
import { CommonMenus, codicon } from '@theia/core/lib/browser';
...
export namespace CommonMenusEs {
    ...
    export const ES_TEST_SPEECH = [...ES_FILE, 'gr2'];
...
@injectable()
export class ItNelsonCmdCommandContribution implements CommandContribution {
    ...
    registerCommands(registry: CommandRegistry): void {
       // registry.registerCommand(ItNelsonCmdCommand, {
...
@injectable()
export class ItNelsonCmdMenuContribution implements MenuContribution {

    registerMenus(menus: MenuModelRegistry): void {

         menus.registerSubmenu(CommonMenusEs.ES_FILE, 'test1');
